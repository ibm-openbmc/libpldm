...
TEST(PDRUpdate, testAddFruRecordSet)
{
    ...
    uint32_t handle = 0;
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(repo, 1, 10, 1, 0, 100, &handle,
                                                false),
              0);
    EXPECT_EQ(handle, 1u);
    EXPECT_EQ(pldm_pdr_get_record_count(repo), 1u);
    ...
    handle = 0;
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(repo, 2, 11, 2, 1, 101, &handle,
                                                false),
              0);
    EXPECT_EQ(handle, 2u);
    EXPECT_EQ(pldm_pdr_get_record_count(repo), 2u);
...
TEST(PDRUpdate, tesFindtFruRecordSet)
{
    ...
    uint32_t first = 1;
    EXPECT_EQ(
        pldm_pdr_add_fru_record_set_check(repo, 1, 1, 1, 0, 100, &first, false),
        0);
    uint32_t second = 2;
    ...
    uint32_t third = 3;
    EXPECT_EQ(
        pldm_pdr_add_fru_record_set_check(repo, 1, 3, 1, 2, 100, &third, false),
        0);
...
TEST(EntityAssociationPDR, findAndAddRemotePDR)
{
    ...
    auto result1 = pldm_entity_association_tree_find(tree, &entity, false);
    ...
    auto result2 = pldm_entity_association_tree_find(tree, &entity, false);
...
TEST(EntityAssociationPDR, testEntityInstanceNumber)
{
    ...
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(
                  ...
                  entities[1].entity_container_id, &first, false),
              0);
    EXPECT_NE(l1, nullptr);
    ...
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(
                  ...
                  entities[2].entity_container_id, &second, false),
              0);
    EXPECT_NE(l2, nullptr);
    ...
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(
                  ...
                  entities[3].entity_container_id, &third, false),
              0);
    EXPECT_NE(l3, nullptr);
    ...
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(
                  ...
                  entities[4].entity_container_id, &fourth, false),
              0);
    ...
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(
                  ...
                  entities[5].entity_container_id, &fifth, false),
              0);
    ...
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(
                  ...
                  entities[7].entity_container_id, &seventh, false),
              0);
    ...
    EXPECT_EQ(pldm_pdr_add_fru_record_set_check(
                  ...
                  entities[8].entity_container_id, &eighth, false),
              0);
